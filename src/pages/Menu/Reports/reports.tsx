  ...
  return (
    <IonPage>
      ...
      <IonToolbar>
                    <IonGrid>
                        <IonRow>
                            ...
                            <IonCol size='7.5'>
                                <IonLabel id='plot-txt'>Reports</IonLabel></IonCol><IonCol size='2.5'>
      ...
      <IonContent fullscreen>
          <IonButton fill='clear' id='txt2'> Agent Report &nbsp;<IonIcon icon={arrowForwardCircle}>
          </IonIcon></IonButton>
          <IonButton fill='clear' id='txt2'> Agent Tree View Report&nbsp;<IonIcon icon={arrowForwardCircle}>
          </IonIcon></IonButton>
      </IonContent>
    </IonPage>
  );
